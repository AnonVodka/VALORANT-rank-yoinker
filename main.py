            ...
            if game_state == "INGAME":
                ...
                with alive_bar(total=len(Players), title='Fetching Players', bar='classic2') as bar:
                    ...
                    for player in Players:
                        ...
                        playerRank = rank.get_rank(player["Subject"], seasonID, lastSeasonID)    
                        ...
                        Namecolor = colors.get_color_from_team(player["TeamID"], names[player["Subject"]], player["Subject"], Requests.puuid)
                        ...
                        peakSeason = content.get_name_from_season_id(gameContent, playerRank[-1])
                ...
                with alive_bar(total=len(Players), title='Fetching Players', bar='classic2') as bar:
                    ...
                    for player in Players:
                        ...
                        if player["PlayerIdentity"]["Incognito"]:
                            NameColor = colors.get_color_from_team(pregame_stats['Teams'][0]['TeamID'], names[player["Subject"]], player["Subject"], Requests.puuid, agent=player["CharacterID"])
                        else:
                            NameColor = colors.get_color_from_team(pregame_stats['Teams'][0]['TeamID'], names[player["Subject"]], player["Subject"], Requests.puuid)
